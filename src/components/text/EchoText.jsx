...
/* Texto com rastro: cópias fantasma atrás da frente, que perseguem a posição
 * alvo com atraso crescente. Entram espalhadas e se juntam, e depois seguem o
 * cursor de leve.
 *
 * Componente do React Bits, adaptado ao repo: 'use client' no topo (a página é
 * server component) e o CSS movido para o globals.css, junto com o resto dos
 * componentes portados. A lógica é a original.
 *
  ...
  useEffect(() => {
    ...
    const renderFrame = (now) => {
      ...
      for (let index = 0; index <= echoCount; index += 1) {
        ...
        /* quanto mais fundo o eco, mais devagar ele persegue o alvo */
      ...
      /* os ecos só aparecem quando há movimento: separação entre as cópias ou
         velocidade do alvo */
